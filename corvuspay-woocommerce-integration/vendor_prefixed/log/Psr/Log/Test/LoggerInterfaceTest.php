...
namespace CorvusPay\Vendor\Psr\Log\Test;

use CorvusPay\Vendor\Psr\Log\LoggerInterface;
use CorvusPay\Vendor\Psr\Log\LogLevel;
use CorvusPay\Vendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('CorvusPay\Vendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('CorvusPay\Vendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('CorvusPay\Vendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
