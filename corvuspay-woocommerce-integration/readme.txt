...
= 2.7.1 =
* Cleanup: Removed redundant psr/log library from vendor.
* Fixed: Resolved bug when changing subscription token.

= 2.7.0 =
* Enhanced: Isolated psr/log logger using php-scoper to prevent conflicts with other plugins.

= 2.6.5 =
* Fixed: Function _load_textdomain_just_in_time was called incorrectly.
* Fixed: Correct total amount is now shown when using advanced installments.
...
= 2.6.2 =
* Fixed paths to Block-based checkout related files.

= 2.6.1 =
* Added nonce and permission check to the AJAX action for completing orders to enhance security.

= 2.6.0 =
* Block based checkout and HPOS support.
